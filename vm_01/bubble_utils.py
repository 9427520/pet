...
def health_cards_bubble(formatted_result):
    with open(r'C:\Users\T14 Gen 3\Desktop\pydm\vm_01\card_edit.json', encoding='utf-8') as f:
        bubble = json.load(f)
        ...
        bubble['footer']['contents'][1]['action']['uri'] = f"https://liff.line.me/2005517118-y7Y7mPLA?{encoded_params}"
